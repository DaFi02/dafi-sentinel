...
- [ ] 2.1 PR2 add RED/GREEN ingestion tests/services for valid datasets, malformed rollback, traceability, redaction handoff.
- [ ] 2.1a PR2 add standalone valid incident, malformed row, runbook/document, and prompt-injection fixtures removed from PR1 to stay under review budget.
- [ ] 2.2 PR2 add RED/GREEN security tests/services for injection-as-data, policy refusal, redaction, role-based tool authorization, approvals, audits.
